# -*- coding: utf-8 -*-
"""
Created on Mon Apr 02 14:15:35 2018
    ...
    while not validinput:
        try:
            ...
            if categorychoice < 1 or categorychoice > 3 :
                ...
                # Kibet is an instance of Storekeeper, add the movie to Storekeeper's movies                      
                Kibet.movies.append(movie)
...
def return_movie():
    ...
    for customer in customer_list:
        if customer.idno == idno:
            ...
            for loan_movie_dictionary in Kibet.movies_lent:                       
                ...
                if movie.name == movie_name:
                    ...
                    Kibet.movies_lent.remove(loan_movie_dictionary)
                    customer.my_movies.remove(movie)
                    customer.movies_returned.append(movie)                             
                    print "Movies in the store %s" % Kibet.movies
